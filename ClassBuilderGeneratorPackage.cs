...
namespace ClassBuilderGenerator
{
    ...
    {
        /// <summary>
        /// ClassBuilderGeneratorPackage GUID string.
        /// </summary>
        public const string PackageGuidString = "a9f67d60-554c-47d0-ac07-fb09bb79088d";

        /// <summary>
        /// Initializes a new instance of the <see cref="ClassBuilderGeneratorPackage"/> class.
        /// </summary>
        public ClassBuilderGeneratorPackage()
        {
        ...
        protected override async Task InitializeAsync(CancellationToken cancellationToken, IProgress<ServiceProgressData> progress)
        {
            ...
            await ClassBuilderGenerator.InitializeAsync(this);
        }
